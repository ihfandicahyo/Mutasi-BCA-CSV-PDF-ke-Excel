...
- [Unduh modul ini]([https](https://github.com/ihfandicahyo/Mutasi-BCA-CSV-ke-Excel/archive/refs/tags/1.1.zip)) dan ekstrak
- Buat folder baru dan letakkan modul yang telah di unduh pada folder tersebut 
- bcacsv2excel.py (untuk konversi csv ke excel)
- bcacsv2exceldbcr.py (untuk komversi csv ke excel dan memisahkan nominal debit/credit)
